#0 Creación de la tabla employees:
...
# 3: Agregar columna age con CHECK (16 a 70 años)
ALTER TABLE employees ADD COLUMN age INT;
ALTER TABLE employees ADD CONSTRAINT chk_age CHECK (age BETWEEN 16 AND 70);


# 4: Integridad referencial en Sakila (Explicativa)
...
# 5: Columnas lastUpdate y lastUpdateUser + Triggers de Auditoría
...
# 6: Triggers de film_text en Sakila (Explicativa)
